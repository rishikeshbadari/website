document.addEventListener('DOMContentLoaded', function() {
    ...
    // Function to switch between fractal branches (no implicit event global)
    ...
    // Bind fractal buttons via event delegation (avoids implicit event global)
    ...
    // Initialize fractal content when modal opens
    ...
    // Bind olympic report buttons via event delegation
